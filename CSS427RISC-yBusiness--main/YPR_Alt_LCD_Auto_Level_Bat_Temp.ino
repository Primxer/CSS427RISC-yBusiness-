...
void loop() {
  ...
  if ((mpuIntStatus & 0x10) || fifoCount == 1024) {
    ...
    byte temp = (byte)round(analogRead(tempPin) * 0.48828125);

    //read the battery voltage and map it to percent
